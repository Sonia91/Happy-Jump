...
public class Audio implements ReleasableResource {
	...
	/** 預設的左聲道音量。 */
	public static final int DEFAULT_LEFT_VOLUME = 5;

	/** 預設的右聲道音量。 */
	public static final int DEFAULT_RIGHT_VOLUME = 5;
...
/**	private int leftVol=DEFAULT_LEFT_VOLUME;
	private int rightVol=DEFAULT_RIGHT_VOLUME;
	public void addVolume(int Vol){
		leftVol=leftVol+Vol;
		rightVol=rightVol+Vol;
