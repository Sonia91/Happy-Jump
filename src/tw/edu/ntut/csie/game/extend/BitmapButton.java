...
public class BitmapButton implements GameObject, PointerEventHandler {
	 ...
	 * @param y 按鈕的X座標 
	 */
	public BitmapButton(int normalImage, int pressedImage, int x, int y){//, int width, int height) {
		this(normalImage);
	 ...
	 * @param y 按鈕的X座標 
	 */
	public BitmapButton(String normalImage, String pressedImage, int x, int y){//, int width, int height) {
		this(normalImage);
		loadPressedBitmap(pressedImage);
		setLocation(x, y);
		//Resize(width,height);
	...
	public void Resize(int width, int height) {
		setImageLocation(_normalImage, width, height);
		setImageLocation(_hoveredImage, width, height);
		setImageLocation(_pressedImage, width, height);
		/*_normalImage.resize(width, height);
		_hoveredImage.resize(width, height);
		_pressedImage.resize(width, height);*/
	...
	private void ImageResize(MovingBitmap image, int width, int height) {
		if(image != null) {
